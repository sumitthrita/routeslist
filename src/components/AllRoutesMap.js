...
const AllRoutesMap = props => {
    const routes = props.routes // array of objects of each route
    ...
    useEffect(() => {
        ...
        let map = tt.map({
            ...
            center: [parseFloat(routes[0].startPoint.longitude), parseFloat(routes[0].startPoint.latitude)],
            zoom: 9
        })
